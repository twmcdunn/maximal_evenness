...
let dgObj = buildAnimation(svg, 12, 8, 1, ["C", "C\u266F", "D", "E\u266D", "E", "F", "F\u266F", "G", "A\u266D", "A", "B\u266D", "B"], true);
masterSvg.appendChild(svg);
animates.push(dgObj.addPolygon);
animates.push(dgObj.animate);

function respell(){
    let notesArr = ["B\u266F", "C\u266F", "D", "D\u266F", "E", "F", "F\u266F", "G", "A\u266D", "A", "A\u266F", "B"];
    let n = 0;
    dgObj.nodes.forEach((visualNode) => {
        visualNode.name.textContent = notesArr[n++];
    });
    dgObj.labelText.textContent = "Respelled";
}

animates.push(respell);
